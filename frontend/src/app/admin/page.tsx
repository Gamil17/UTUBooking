 ...
 *
 * Row 0 — Platform overview stats (users, pending, inventory, revenue)
 * Row 1 — RevPAR by market (Makkah / Madinah)
 * Row 2 — Conversion funnel by country + device
 * Row 3 — AI pricing recommendations with Accept / Reject actions
 */
