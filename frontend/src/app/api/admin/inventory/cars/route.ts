/**
 * BFF: GET /api/admin/inventory/cars
 * → admin service GET /admin/api/cars
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res  = await fetch(`${ADMIN_SVC}/admin/api/cars?${params}`, {
      headers: adminHeader(),
      cache:   'no-store',
    });
    ...
    console.error('[admin/inventory/cars BFF] error:', err);
