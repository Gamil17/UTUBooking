/**
 * BFF: GET /api/admin/inventory/hotels
 * → admin service GET /admin/api/hotels
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res  = await fetch(`${ADMIN_SVC}/admin/api/hotels?${params}`, {
      headers: adminHeader(),
      cache:   'no-store',
    });
    ...
    console.error('[admin/inventory/hotels BFF] error:', err);
