/**
 * BFF: GET /api/admin/inventory/flights
 * → admin service GET /admin/api/flights
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res  = await fetch(`${ADMIN_SVC}/admin/api/flights?${params}`, {
      headers: adminHeader(),
      cache:   'no-store',
    });
    ...
    console.error('[admin/inventory/flights BFF] error:', err);
