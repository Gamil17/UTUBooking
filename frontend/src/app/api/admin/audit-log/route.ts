/**
 * BFF: GET /api/admin/audit-log
 * → admin service GET /admin/api/audit-log
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res  = await fetch(`${ADMIN_SVC}/admin/api/audit-log?${params}`, {
      headers: adminHeader(),
      cache:   'no-store',
    });
    ...
    console.error('[admin/audit-log BFF] error:', err);
